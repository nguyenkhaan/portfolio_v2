...
function Profile() {
    return (
        <motion.div
            className='w-full gap-16 md:px-40 px-10 md:flex-row flex flex-col-reverse py-15 md:min-h-80 min-h-screen items-center justify-between'
            initial={{ x: -400, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            // whileInView={{opacity(window.width >= 1000)}}
        ...
        >
            ...
            <div className='flex-1 flex items-center justify-end'>
                <motion.div
                    className='rounded-full w-60 h-60 bg-red-500 cursor-pointer bg-center bg-cover bg-no-repeat shadow-[0_0_30px_10px_rgba(0,128,255,0.6)]'
