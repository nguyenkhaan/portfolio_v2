    ...
    return (
        ...
        >
            <div className='absolute top-0 left-0 bg-black right-0  flex-col bottom-0 opacity-50 flex items-center justify-center'>
                <h2 className='font-bold text-4xl px-60 leading-12 block text-center line-clamp-2 w-full text-white'>Do you have any Idea?
                    <br />Let's talk about your work progress</h2>
                <span className='text-base text-white text-center block w-full px-100 my-4'>There are many variations of passages of Lorem Ipsum available,
